...
driver1 = classes.Coil(copper, 0.015, 0.1, 1, 0.00129)
driver2 = classes.Coil(copper, 0.015, 0.1, 1, 0.00129)
driver3 = classes.Coil(copper, 0.015, 0.1, 1, 0.00129)
driver4 = classes.Coil(copper, 0.015, 0.1, 1, 0.00129)
driver5 = classes.Coil(copper, 0.015, 0.1, 1, 0.00129)

# Stages
# Coil, position, trigger position, capacitance, charge voltage
stage1 = classes.Stage(driver1, 0.0, 0.0, 0.003 * 1, 1000)
stage2 = classes.Stage(driver2, 0.1, 0.1, 0.003 * 1, 1000)
stage3 = classes.Stage(driver3, 0.2, 0.2, 0.003 * 1, 1000)
stage4 = classes.Stage(driver4, 0.3, 0.3, 0.003 * 1, 1000)
stage5 = classes.Stage(driver5, 0.4, 0.4, 0.003 * 1, 1000)
...
figs.colorbar(radialc, ax=radial)
